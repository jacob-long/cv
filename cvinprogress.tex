...
%\item Committee: Dr. William P. ``Chip'' Eveland (advisor), Michael D. Slater, Gerald Kosicki, Robert M. Bond
\item Advisor: Dr. William P. ``Chip'' Eveland
\end{list2}
%\vspace*{.05in}
%\item[] M.A., Communication, 2019
\end{list1}
...
%{\bf Long, J.A.} (2013, April). \emph{Masculinity and transational Spanish stardom in} Celda 211. Paper presented to the Rhodes College's Symposium on Gender and Sexuality Studies, Memphis, TN.
...
\vspace*{-2.5mm}
\emph{Summer 2018}: COMM 3554: Social Implications of Communication Technology. Taught online. 
...
%\begin{list2}
%\item Statistical Packages:  R, Stata, SPSS.
%\item \LaTeX
